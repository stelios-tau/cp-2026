...
\subtitle{Week 19 (Lecture 10) : \textbf{Virtual threads}}
...
\begin{frame}[fragile]
  ...
  \begin{block}{\faLightbulb \quad Structured Concurrency}
    ...
    structured programming aims to bring more order to concurrent programming.
...
\begin{frame}[fragile]
  ...
  \item[\faCode]<1-> Week19/VirtualThreads1.java and
    Week19/VirtualThreads1.java : two more examples of virtual threads.
  \end{itemize}
