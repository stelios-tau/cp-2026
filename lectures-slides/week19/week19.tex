...
\begin{frame}[fragile]
  ...
  \item[\faBook]<4-> \textbf{Use Case:} Designed for tasks that spend a lot of
    ...
    CPU-intensive work, but to allow vastly more concurrent operations.
  \end{itemize}
\end{frame}
...
\begin{frame}[fragile]
  ...
  \item[\faBook]<1-> JVM uses scheduling tricks to keep things efficient.
  \item[\faBook]<1-> Under the hood, JVM uses a ForkJoinPool.
  \end{itemize}
\end{frame}
