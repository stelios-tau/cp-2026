...
\end{lstlisting}
  ...
  \item[\faBook] Little control over how many are running.
...
\begin{frame}[fragile]
  ...
  \begin{table}[h]
    ...
    \begin{tabularx}{\textwidth}{|l|c|c|c|X|}
      ...
      \hline
      \texttt{PriorityQ} & Yes & Built-in & Priority & Scheduling and ordered tasks \\
      \hline
      \texttt{ExecutorService} & Yes & Built-in & Depends & Modern thread management \\
      \hline
    \end{tabularx}
