...
public class SpinlockMap2T
{
	public static void main(String[] args)
	{
		...
		Thread t1 = new Thread( () -> computeOccurrences( "lectures/text1.txt", occurrences, locked ) );
		Thread t2 = new Thread( () -> computeOccurrences( "lectures/text2.txt", occurrences, locked ) );
